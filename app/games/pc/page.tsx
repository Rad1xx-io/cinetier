...
const DESCRIPTION =
  "Browse PC games by genre, platform and mode, then rank the ones you have played into tiers from S to F.";

export const metadata: Metadata = {
  title: "PC Games — TierListOnline",
  description: DESCRIPTION,
  alternates: { canonical: "/games/pc" },
  openGraph: {
    title: "PC Games — TierListOnline",
    description: DESCRIPTION,
    url: "/games/pc",
  },
  twitter: { title: "PC Games — TierListOnline", description: DESCRIPTION },
};
